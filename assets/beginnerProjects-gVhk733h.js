...
}`}],tips:["모바일 터치 영역은 최소 44x44px이어야 합니다 (Apple HIG 기준)","transition은 hover 효과에, animation은 등장/퇴장 효과에 사용하세요","빈 상태(Empty State) 메시지를 추가하면 UX가 크게 향상됩니다"]}]},{id:"portfolio",slug:"portfolio",title:"포트폴리오 사이트 만들기",description:"반응형 개인 포트폴리오 사이트. 다크모드와 섹션 구성 포함.",level:"beginner",duration:"3-4시간",techStack:["React","v0.dev","CSS"],outcomes:["반응형 디자인 구현","다크모드 토글","섹션 기반 레이아웃"],diagram:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 460" font-family="'Noto Sans KR', sans-serif">
  <defs>
