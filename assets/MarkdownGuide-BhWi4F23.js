import{r as h,h as k,a as g,j as e}from"./index-BTNUaOzl.js";import{S as x}from"./SidebarLayout-DBQjbUAu.js";import{C as b}from"./CodeBlock-Cywd_VGf.js";const r=[{id:"line-break",slug:"line-break",title:"줄바꿈과 문단",description:"마크다운에서 줄바꿈과 문단을 구분하는 방법",order:1,content:`마크다운에서 줄바꿈은 단순히 Enter를 누르는 것과 다릅니다. 줄 끝에 공백 2개를 넣거나, 빈 줄을 넣어 문단을 구분합니다.
...
\`\`\``,rendered:""}]}],j=()=>{const[i,l]=h.useState(r[0]?.id||""),{isCompleted:d,toggleComplete:o,getProgressPercent:s}=k(),{isLoggedIn:a}=g(),t=r.find(n=>n.id===i)||r[0],m=r.map(n=>n.id),c=s("markdown",m),p=r.map(n=>({id:n.id,title:n.title,completed:d("markdown",n.id)}));return e.jsxs("div",{className:"curriculum-page",children:[e.jsx("div",{className:"curriculum-header",children:e.jsxs("div",{className:"container",children:[e.jsx("h1",{children:"마크다운 가이드"}),e.jsx("p",{children:"AI 프롬프트와 개발 문서에 필수인 마크다운 문법을 마스터하세요."})]})}),e.jsx(x,{title:"마크다운 챕터",items:p,activeId:i,onSelect:l,progressPercent:c,children:t&&e.jsxs("div",{className:"topic-content",children:[e.jsx("h2",{children:t.title}),e.jsx("p",{className:"topic-description",children:t.description}),e.jsx("div",{className:"topic-text",dangerouslySetInnerHTML:{__html:t.content.replace(/\n/g,"<br/>")}}),t.examples.map((n,u)=>e.jsxs("div",{className:"markdown-example",children:[e.jsx("h4",{children:n.title}),e.jsxs("div",{className:"markdown-split",children:[e.jsxs("div",{className:"markdown-input",children:[e.jsx("h5",{children:"마크다운"}),e.jsx(b,{code:n.markdown,language:"markdown"})]}),e.jsxs("div",{className:"markdown-output",children:[e.jsx("h5",{children:"결과"}),e.jsx("div",{className:"markdown-rendered",dangerouslySetInnerHTML:{__html:n.rendered||""}})]})]})]},u)),a&&e.jsx("div",{className:"topic-complete-action",children:e.jsx("button",{className:`btn ${d("markdown",t.id)?"btn-completed":"btn-primary"}`,onClick:()=>o("markdown",t.id),children:d("markdown",t.id)?"✓ 학습 완료":"학습 완료 표시"})})]})})]})};export{j as default};
